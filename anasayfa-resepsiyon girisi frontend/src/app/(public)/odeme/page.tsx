      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <div className="flex-1 p-12 flex flex-col items-center relative z-10 overflow-y-auto">
          ...
          <div className="bg-white w-full max-w-[900px] rounded-xl p-8 md:px-10 shadow-[0_8px_24px_rgba(0,0,0,0.04)] relative z-10">
            ...
            <div className="mb-8">
              <h2 className="text-[1.35rem] font-semibold text-[#1a3b25] mb-1.5">Ödeme</h2>
              <p className="text-[0.9rem] text-[#888]">Ödeme işlemini tamamlayarak rezervasyonunuzu kesinleştirin.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 gap-x-8 mb-8">
                ...
                <div className="flex flex-col md:col-span-2">
                  <label className="text-[0.9rem] font-semibold text-[#555] mb-2"><span className="text-[#d9534f] mr-1">*</span>Kart Üzerindeki İsim</label>
                  <input type="text" placeholder="Ad Soyad" className="w-full bg-white text-[#333] border border-[#ccc] rounded-md py-3 px-[15px] text-[0.95rem] outline-none transition-shadow focus:border-[#1a3b25] focus:shadow-[0_0_0_2px_rgba(26,59,37,0.2)]" required />
                </div>

                <div className="flex flex-col md:col-span-2">
                  <label className="text-[0.9rem] font-semibold text-[#555] mb-2"><span className="text-[#d9534f] mr-1">*</span>Kart Numarası</label>
                  <input type="text" placeholder="XXXX XXXX XXXX XXXX" maxLength={19} className="w-full bg-white text-[#333] border border-[#ccc] rounded-md py-3 px-[15px] text-[0.95rem] outline-none transition-shadow focus:border-[#1a3b25] focus:shadow-[0_0_0_2px_rgba(26,59,37,0.2)]" required />
                </div>

                <div className="flex flex-col">
                  <label className="text-[0.9rem] font-semibold text-[#555] mb-2"><span className="text-[#d9534f] mr-1">*</span>Son Kullanma Tarihi</label>
                  <input type="text" placeholder="AA / YY" maxLength={5} className="w-full bg-white text-[#333] border border-[#ccc] rounded-md py-3 px-[15px] text-[0.95rem] outline-none transition-shadow focus:border-[#1a3b25] focus:shadow-[0_0_0_2px_rgba(26,59,37,0.2)]" required />
                </div>

                <div className="flex flex-col">
                  <label className="text-[0.9rem] font-semibold text-[#555] mb-2"><span className="text-[#d9534f] mr-1">*</span>CVC / CVV</label>
                  <input type="text" placeholder="XXX" maxLength={3} className="w-full bg-white text-[#333] border border-[#ccc] rounded-md py-3 px-[15px] text-[0.95rem] outline-none transition-shadow focus:border-[#1a3b25] focus:shadow-[0_0_0_2px_rgba(26,59,37,0.2)]" required />
                </div>
              ...
              <div className="flex justify-between items-center relative">
                <Link href="/on-izleme" className="bg-white border border-[#ccc] text-[#555] py-2.5 px-6 rounded-md text-[0.9rem] font-medium inline-flex items-center gap-2 transition-colors hover:bg-[#f0f0f0]">
                  ← Geri
                </Link>
